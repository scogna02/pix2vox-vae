...
__C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH    = '/kaggle/working/pix2vox-vae/datasets/ShapeNet-f.json'
# __C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH  = './datasets/PascalShapeNet.json'
__C.DATASETS.SHAPENET.RENDERING_PATH        = '/kaggle/working/ShapeNetRendering/%s/%s/rendering/%02d.png'
# __C.DATASETS.SHAPENET.RENDERING_PATH      = '/home/hzxie/Datasets/ShapeNet/PascalShapeNetRendering/%s/%s/render_%04d.jpg'
__C.DATASETS.SHAPENET.VOXEL_PATH            = '/kaggle/working/ShapeNetVox32/%s/%s/model.binvox'
...
__C.TRAIN.ENCODER_LEARNING_RATE             = 5e-3
__C.TRAIN.DECODER_LEARNING_RATE             = 5e-3
__C.TRAIN.REFINER_LEARNING_RATE             = 5e-3
__C.TRAIN.MERGER_LEARNING_RATE              = 1e-4
__C.TRAIN.ENCODER_LR_MILESTONES             = [30]
__C.TRAIN.DECODER_LR_MILESTONES             = [30]
__C.TRAIN.REFINER_LR_MILESTONES             = [30]
__C.TRAIN.MERGER_LR_MILESTONES              = [30]
